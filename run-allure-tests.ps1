# Variables for paths
$reportHistory = "allure-report\history"
$tempHistory = "history_temp"
$rootResults = "allure-results"
...
# Step 6: Generate the Allure report in root
allure generate $rootResults -o allure-report --clean
