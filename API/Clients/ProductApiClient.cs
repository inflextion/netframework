...
namespace atf.API.Clients
{
    ...
    {
        public ProductApiClient(string baseUrl) : base(baseUrl) { }
        ...
        public async Task<ProductRequest> CreateProductAsync(ProductRequest product, bool isTestRequest = false)
        {
            ...
            return await SendAsync<ProductRequest, ProductRequest>(Method.Post, "/api/products", product);
        }
        ...
        {
            await SendAsync(Method.Delete, $"/api/products/{productId}", (object)null);
        }
